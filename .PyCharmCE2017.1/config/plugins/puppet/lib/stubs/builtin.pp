...
define group(
  ...
  # <p>Whether the provider is authoritative for group membership. This
  ...
  # are inclusive or the minimum.</p>
  #
...
#   <li>Default for <code>operatingsystem</code> == <code>fedora</code> and <code>operatingsystemmajrelease</code> == <code>22, 23, 24</code>.</li>
...
#
# <pre><code>ssh-rsa AAAAB3Nza[...]qXfdaQ== nick@magpie.puppetlabs.lan
# </code></pre>
#
