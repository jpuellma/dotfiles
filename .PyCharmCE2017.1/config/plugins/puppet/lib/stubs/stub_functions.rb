...
<ul>
  <li>
    <p>Since 4.0.0 support for Class and Resource Type values, absolute names</p>
  </li>
  <li>
...
<p><code>epp('apache/templates/vhost/_docroot.epp', { 'docroot' =&gt; '/var/www/html',
...
<ul>
  <li>
    <p>Since 4.0.0 Class and Resource types, absolute names</p>
  </li>
  <li>
    <p><em>Type</em>: statement</p>
  </li>
